...
import { TextField, Card, Button, CardProps, ButtonProps, StandardTextFieldProps, DialogProps, Dialog, DialogTitle, DialogContent, DialogActions } from '@mui/material';
      ...
      <DialogActions
        ...
        {props.actions
          ? (props.actions.map((action) => {
            return <Button key={action.name} onClick={action.action}>{action.name}</Button>
          })
          ):(
            <p></p>
          )
